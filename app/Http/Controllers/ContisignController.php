...
class ContisignController extends Controller
{
    ...
    public function generateDocumentRegularizacion(Request $request)
    {
        try {
            ...
            $data = self::sendTemplate($credito_data, $request, "27b06828-3a61-40ab-b0dc-f3f4b638e329", $template_values, $this->contisign, "FORMATO REESTRUCTURA", 1);
    ...
    private static function sendTemplate($credito_data, $request, $template_id, $template_values, $contisign, $format, $id_subtipo)
    {
        ...
        $html = self::fillTemplateHTML($template["Templates"], $fields);
        $data = TemplateController::template($contisign, $signatures, $template, $fields, $html, $request, $annexed, $annexedSelfie, $obj, $peredo);
        return $data;
    }
